...
public class CasoEvaluado {
    ...
    public static void main(String[] args) {
        ...
        do {            
            ...
            boolean tieneElectricos = JOptionPane.showInputDialog("¿Incluye productos eléctricos? (sí/no):n").equalsIgnoreCase("sí");
            boolean tieneAutomotrices = JOptionPane.showInputDialog("¿Incluye productos automotrices? (sí/no): ").equalsIgnoreCase("sí");
            boolean tieneConstruccion = JOptionPane.showInputDialog("¿Incluye productos de construcción? (sí/no): ").equalsIgnoreCase("sí");
            ...
            double bono = 0;
            int puntos = 0;
            boolean tieneTresTipos = (tieneElectricos && tieneAutomotrices && tieneConstruccion);
            ...
            continuar = JOptionPane.showConfirmDialog(null, "desea ingresar otra actividad?", "continuar", JOptionPane.YES_NO_OPTION); //una casilla donde habrá una opción de sí y no
